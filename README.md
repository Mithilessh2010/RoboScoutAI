...
- `FTC_API_BASE_URL`: Defaults to `https://ftc-events.firstinspires.org`.
- `FTC_API_USERNAME`: Server-only FTC Events API username.
- `FTC_API_TOKEN`: Server-only FTC Events API token. Never expose this in browser code or commit it.
