...
export interface IAutoscoreGateEvent extends Document {
    ...
    alliance: "red" | "blue";
    timestamp: number;
    eventType: "manual_gate_opened" | "possible_gate_opened_future";
...
const autoscoreGateEventSchema = new Schema<IAutoscoreGateEvent>(
    {
        ...
        eventType: {
            type: String,
            enum: ["manual_gate_opened", "possible_gate_opened_future"],
...
export const AutoscoreGateEvent =
    ...
    mongoose.model<IAutoscoreGateEvent>("AutoscoreGateEvent", autoscoreGateEventSchema);
