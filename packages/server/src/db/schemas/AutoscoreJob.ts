...
const autoscoreJobSchema = new Schema<IAutoscoreJob>(
  {
    ...
    motif: {
      type: String,
      enum: ["GPP", "PGP", "PPG", "manual", "unknown"],
      default: "unknown",
    },
    modelPath: {
      type: String,
      default: "services/video-processing/models/decode/best.pt",
    },
    robotModelPath: {
      type: String,
      default: "services/video-processing/models/decode/robot/best.pt",
    },
...
export const AutoscoreJob =
  ...
  mongoose.model<IAutoscoreJob>("AutoscoreJob", autoscoreJobSchema);
