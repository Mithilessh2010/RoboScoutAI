...
exports.Descriptor2024 = exports.ITDPark = void 0;
...
const ITDParkDTy = (0, types_1.EnumDTy)(exports.ITDPark, "ITDPark", "itd_park_enum");
function parkFromApi(api) {
    switch (api) {
        case "OBSERVATION_ZONE":
            return exports.ITDPark.ObservationZone;
        case "ASCENT_1":
        case "ASCENT":
            return exports.ITDPark.Ascent1;
        case "ASCENT_2":
            return exports.ITDPark.Ascent2;
        case "ASCENT_3":
            return exports.ITDPark.Ascent3;
        case "NONE":
            return exports.ITDPark.None;
    }
}
...
exports.Descriptor2024 = new descriptor_1.Descriptor({
    season: Season_1.Season.IntoTheDeep,
    ...
    .addColumn(new descriptor_1.DescriptorColumn({ name: "autoPark1" })
    .addMatchScore({
    ...
    .addColumn(new descriptor_1.DescriptorColumn({ name: "autoPark2" })
    .addMatchScore({
    ...
    .addColumn(new descriptor_1.DescriptorColumn({ name: "autoSampleNet" }).addMatchScore({
    fromApi: (api) => api.autoSampleNet,
    dataTy: types_1.Int16DTy,
}))
    .addColumn(new descriptor_1.DescriptorColumn({ name: "autoSampleLow" }).addMatchScore({
    fromApi: (api) => api.autoSampleLow,
    dataTy: types_1.Int16DTy,
}))
    .addColumn(new descriptor_1.DescriptorColumn({ name: "autoSampleHigh" }).addMatchScore({
    fromApi: (api) => api.autoSampleHigh,
    dataTy: types_1.Int16DTy,
}))
    .addColumn(new descriptor_1.DescriptorColumn({ name: "autoSpecimenLow" }).addMatchScore({
    fromApi: (api) => api.autoSpecimenLow,
    dataTy: types_1.Int16DTy,
}))
    .addColumn(new descriptor_1.DescriptorColumn({ name: "autoSpecimenHigh" }).addMatchScore({
    fromApi: (api) => api.autoSpecimenHigh,
    dataTy: types_1.Int16DTy,
}))
    .addColumn(new descriptor_1.DescriptorColumn({ name: "dcPark1" })
    .addMatchScore({
    ...
    .addColumn(new descriptor_1.DescriptorColumn({ name: "dcPark2" })
    .addMatchScore({
    ...
    .addColumn(new descriptor_1.DescriptorColumn({ name: "dcSampleNet" }).addMatchScore({
    fromApi: (api) => api.teleopSampleNet,
    dataTy: types_1.Int16DTy,
}))
    .addColumn(new descriptor_1.DescriptorColumn({ name: "dcSampleLow" }).addMatchScore({
    fromApi: (api) => api.teleopSampleLow,
    dataTy: types_1.Int16DTy,
}))
    .addColumn(new descriptor_1.DescriptorColumn({ name: "dcSampleHigh" }).addMatchScore({
    fromApi: (api) => api.teleopSampleHigh,
    dataTy: types_1.Int16DTy,
}))
    .addColumn(new descriptor_1.DescriptorColumn({ name: "dcSpecimenLow" }).addMatchScore({
    fromApi: (api) => api.teleopSpecimenLow,
    dataTy: types_1.Int16DTy,
}))
    .addColumn(new descriptor_1.DescriptorColumn({ name: "dcSpecimenHigh" }).addMatchScore({
    ...
    .finish())
    .addColumn(new descriptor_1.DescriptorColumn({ name: "autoParkPoints" })
    .addMatchScore({
    ...
    .addColumn(new descriptor_1.DescriptorColumn({ name: "autoParkPointsIndividual" }).addTep({
    isIndividual: true,
    make: (ms, station) => parkPoints(station == Station_1.Station.One ? ms.autoPark1 : ms.autoPark2),
    columnPrefix: "Auto Park Individual",
    dialogName: "Individual",
    fullName: "Auto Parking Points Individual",
}))
    .addColumn(new descriptor_1.DescriptorColumn({ name: "autoSamplePoints" })
    .addMatchScore({
    ...
    .addColumn(new descriptor_1.DescriptorColumn({ name: "autoSpecimenPoints" })
    .addMatchScore({
    ...
    .addColumn(new descriptor_1.DescriptorColumn({ name: "autoSampleNetPoints" })
    .addScoreModal({
    displayName: "Net",
    ...
    getTitle: (ms) => (0, n_of_1.nOf)(ms.autoSampleNet, "Sample"),
})
    .addTep({
    ...
    .addColumn(new descriptor_1.DescriptorColumn({ name: "autoSampleLowPoints" })
    .addScoreModal({
    displayName: "Low",
    ...
    getTitle: (ms) => (0, n_of_1.nOf)(ms.autoSampleLow, "Sample"),
})
    .addTep({
    ...
    .addColumn(new descriptor_1.DescriptorColumn({ name: "autoSampleHighPoints" })
    .addScoreModal({
    displayName: "High",
    ...
    getTitle: (ms) => (0, n_of_1.nOf)(ms.autoSampleHigh, "Sample"),
})
    .addTep({
    ...
    .addColumn(new descriptor_1.DescriptorColumn({ name: "autoSpecimenLowPoints" })
    .addScoreModal({
    displayName: "Low",
    ...
    getTitle: (ms) => (0, n_of_1.nOf)(ms.autoSpecimenLow, "Specimen"),
})
    .addTep({
    ...
    .addColumn(new descriptor_1.DescriptorColumn({ name: "autoSpecimenHighPoints" })
    .addScoreModal({
    displayName: "High",
    ...
    getTitle: (ms) => (0, n_of_1.nOf)(ms.autoSpecimenHigh, "Specimen"),
})
    .addTep({
    ...
    .addColumn(new descriptor_1.DescriptorColumn({ name: "dcParkPoints" })
    .addMatchScore({
    ...
    .addColumn(new descriptor_1.DescriptorColumn({ name: "dcParkPointsIndividual" }).addTep({
    isIndividual: true,
    make: (ms, station) => parkPoints(station == Station_1.Station.One ? ms.dcPark1 : ms.dcPark2),
    columnPrefix: "DC Park Individual",
    dialogName: "Individual",
    fullName: "DC Parking Points Individual",
}))
    .addColumn(new descriptor_1.DescriptorColumn({ name: "dcSamplePoints" })
    .addMatchScore({
    ...
    .addColumn(new descriptor_1.DescriptorColumn({ name: "dcSpecimenPoints" })
    .addMatchScore({
    ...
    .addColumn(new descriptor_1.DescriptorColumn({ name: "dcSampleNetPoints" })
    .addScoreModal({
    displayName: "Net",
    ...
    getTitle: (ms) => (0, n_of_1.nOf)(ms.dcSampleNet, "Sample"),
})
    .addTep({
    ...
    .addColumn(new descriptor_1.DescriptorColumn({ name: "dcSampleLowPoints" })
    .addScoreModal({
    displayName: "Low",
    ...
    getTitle: (ms) => (0, n_of_1.nOf)(ms.dcSampleLow, "Sample"),
})
    .addTep({
    ...
    .addColumn(new descriptor_1.DescriptorColumn({ name: "dcSampleHighPoints" })
    .addScoreModal({
    displayName: "High",
    ...
    getTitle: (ms) => (0, n_of_1.nOf)(ms.dcSampleHigh, "Sample"),
})
    .addTep({
    ...
    .addColumn(new descriptor_1.DescriptorColumn({ name: "dcSpecimenLowPoints" })
    .addScoreModal({
    displayName: "Low",
    ...
    getTitle: (ms) => (0, n_of_1.nOf)(ms.dcSpecimenLow, "Specimen"),
})
    .addTep({
    ...
    .addColumn(new descriptor_1.DescriptorColumn({ name: "dcSpecimenHighPoints" })
    .addScoreModal({
    displayName: "High",
    ...
    getTitle: (ms) => (0, n_of_1.nOf)(ms.dcSpecimenHigh, "Specimen"),
})
    .addTep({
    ...
    .addMatchInsightCols(["autoSamplePoints", "autoSpecimenPoints", "dcSamplePoints", "dcSpecimenPoints"], ["autoSamplePoints", "autoSpecimenPoints", "dcSamplePoints", "dcSpecimenPoints"])
    .finish();
//# sourceMappingURL=IntoTheDeepDescriptor.js.map